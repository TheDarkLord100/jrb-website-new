    ...
    <section className="bg-white py-20">
      <div className="mx-auto max-w-[75rem] px-5">
        ...
        <p className="mx-auto mb-14 max-w-2xl text-center text-gray-600">
          ...
          Delhi is an interdisciplinary research centre that aims to advance robotics for real-world
        ...
        <div className="relative">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {verticals.map((v) => (
              ...
              >
                ...
                <p className="mt-3 flex-1 text-sm leading-relaxed text-gray-600">{v.description}</p>
          ...
          >
            ...
            <h3 className="mt-2 font-serif text-xl font-bold text-[#001A23] sm:text-2xl">
              {crossCutting.title}
            </h3>
