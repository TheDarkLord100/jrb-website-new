...
export default function AdminPage() {
  ...
  <div className="mx-auto max-w-md rounded-2xl border border-gray-100 bg-white p-9 shadow-sm">
    ...
    <p className="mb-6 mt-1 text-sm text-gray-400">Authorized personnel only.</p>
    <form className="flex flex-col gap-5">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="user id"
              required
              className="w-full rounded-lg border border-gray-200 py-2.5 pl-10 pr-3.5 text-sm text-gray-700 placeholder-gray-400 outline-none focus:border-[#001A23] focus:ring-4 focus:ring-[#001A23]/10"
            />
          </div>
        </div>
      ...
      <p className="mt-6 text-center text-sm text-gray-600">
        Not an admin? <a href="/" className="font-semibold text-[#001A23] hover:underline">Return to site</a>
      </p>
    </div>
