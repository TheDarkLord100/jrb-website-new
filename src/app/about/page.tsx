      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-5 pb-20 sm:px-20">
        <Card>
          <p className="leading-relaxed text-gray-700">
            Twenty years ago, a group of IIT Delhi students built a robot for a competition. Today,
            that same restless curiosity has grown into an interdisciplinary centre of excellence
            working on some of the hardest problems in robotics — how machines learn from biological
            systems, operate autonomously in unstructured environments, and work safely alongside
            people.
          </p>
        ...
        <Card>
          <h2 className="font-serif text-xl font-bold text-[#001A23]">Inception and Evolution</h2>
          <ul className="mt-5 flex flex-col gap-5 border-l-2 border-amber-400 pl-5">
            {timeline.map((item) => (
              <li key={item.year}>
                <span className="block font-serif text-sm font-bold text-[#001A23]">
                  {item.year}
                </span>
        ...
        <Card>
          ...
          <p className="mt-4 leading-relaxed text-gray-700">
            In 2023, CoE-BIRD played a pivotal role in launching the M.Tech. in Robotics program at
            IIT Delhi, jointly offered by the Departments of Electrical Engineering, Mechanical
